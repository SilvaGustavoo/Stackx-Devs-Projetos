...
while (lado <= 0):
    print("Não existe polignos com medidas negativas ou igual a 0. Por favor tente novamente...")
    lado = float(input("Digite a medida do lado(cm): "))

if (numeroLados < 3):
    print("Não existe polígono com menos de 3 lados!!")
elif (numeroLados == 3):
    ...
    print("Não foi possivel identificar o polígono, tente um com lados variando entre 3 a 5")